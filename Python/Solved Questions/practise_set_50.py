# Python Practise 50 = Apple and Orange (From hackerrank)

"""
Apple and Orange | Problem set :


Get the Problem set here : https://www.hackerrank.com/challenges/apple-and-orange/problem
