# Python Parctise 43 - collections.Counter() (From Hackerrank) = (https://www.hackerrank.com/challenges/collections-counter/problem)
...
Input Format :
    ...
    The next N lines contain the space separated values of the shoe size desired by the customer and x[i],
